    ...
    <footer className="border-t border-border py-16 px-6">
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 mb-16">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><a href="https://instagram.com/primecode321" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:text-primary transition-colors"><Instagram className="size-4" /> Instagram</a></li>
